...
class Spectroplot {
    ...
    */
    enableCanvasClick() {
        ...
        guides.addEventListener('click', function(e) {
            ...
            const dt = y / fft_height * spectro.wf_metadata.total_time; // in s


            const t = new Date(spectro.wf_metadata.start_time.getTime() + 1000 * dt);
    ...
    */
    ...
    getUncorrectedFrequency(t) {
        return parseFloat(this.obs_metadata.frequency) * (1 - this.doppler.getDopplerFactor(t));
    }
    ...
    processHDF5Data() {
        ...
        this.doppler = new DopplerModel(this.obs_metadata.tle,
