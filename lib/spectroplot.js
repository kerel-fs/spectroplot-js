...
import {relativeRangeRate, DopplerModel, date2JulianDate} from './dopplerFactor.js';
...
class Spectroplot {
    ...
    */
    measurementsAdd(dt, df) {
        ...
        cell_t.innerHTML = `${date2JulianDate(t).toFixed(5)}`;
        cell_f.innerHTML = `${f.toFixed(0)}`;


        // Update object
        this.measurements.push({dt: dt.toFixed(1), df: df.toFixed(3)});
    }
